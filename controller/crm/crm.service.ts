...
import { Methods, IssueCRM } from "../../shared/constants";
...
class CRMService {
  async createIssueInCRM(
    ...
    try {
      ...
      logger.info(
        "Error in creating issue in CRM ",
        (error as AxiosResponse)?.data?.message
      );
      return error;
    }
  }

  async updateIssueInCRM(
